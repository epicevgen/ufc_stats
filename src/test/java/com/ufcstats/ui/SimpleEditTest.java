...
@ActiveProfiles("test")
public class SimpleEditTest extends SelenideBaseTest {

    private static final Logger log = LoggerFactory.getLogger(SimpleEditTest.class);

    @Test
    public void testSimpleEditFormDataLoading() {
        log.info("=== Простой тест загрузки данных в форме редактирования ===");
