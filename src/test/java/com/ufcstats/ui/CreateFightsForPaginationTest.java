...
/**
 * Тест для создания боев для демонстрации пагинации
 */
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT)
@ActiveProfiles("test")
public class CreateFightsForPaginationTest {
    ...
    @Test
    void testCreateFightsForPagination() {
        System.out.println("🥊 Создание боев для демонстрации пагинации...");
